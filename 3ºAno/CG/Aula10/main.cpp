...
void renderScene(void) {
	...
	float r = camX*0.0+camY*1.0+camZ*0.0;
	float posr [] =  {0.0+r*dist,0.0+r*dist,0.0+r*dist};
	float posl [] =	 {disp-r*dist,0.0-r*dist,0.0-r*dist};
